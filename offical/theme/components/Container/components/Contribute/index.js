                                ...
                                <div className="main-content">
                                    <Article title='贡献指南'>
                                        ...
                                        <p>Shine Design 是一套为开发者、设计师和产品经理准备的开源 UI 设计语言，旨在提供统一的用户交互设计。它基于 React
                                            开发，并提供了配套的设计资源，充分满足可定制化的需求。</p>
                                        <p>Shine Design 的成长离不开大家的支持，如果你愿意为 Shine Design
                                            贡献代码或提供建议，这篇指南会指导你如何贡献一份自己的力量，请在你要提 issue 或者 pull request
                                            之前花几分钟来阅读一遍这篇指南。</p>
                                        <h4>行为准则</h4>
                                        <p>我们有一份<a
                                            href='//github.com/shine-design/shine-design/blob/master/CODE_OF_CONDUCT.md'>行为准则</a>，希望所有的贡献者都能遵守，请花时间阅读一遍全文以确保你能明白哪些是可以做的，哪些是不可以做的。
                                        </p>
                                        <h4>透明的开发</h4>
                                        <p>我们所有的工作都会放在 <a
                                            href='//github.com/shine-design/shine-design'>GitHub</a> 上。不管是核心团队的成员还是外部贡献者的
                                            Pull Request 都需要经过同样流程的 Code Review。</p>
                                        <h4>分支管理</h4>
                                        <p>基于我们的<a
                                            href='/changelog'>发布周期</a>，我们长期维护两个分支 <code>master</code> 和 <code>feature</code>。如果你要修一个Bug，那么请发
                                            Pull Request 到 <code>master</code>；如果你要提一个增加新功能的 Pull
                                            Request，那么请基于 <code>feature</code> 分支来做。</p>
                                        <h4>Bugs</h4>
                                        <p>我们使用 <a href='//github.com/shine-design/shine-design/issues'>GitHub
                                            Issues</a> 来做 Bug 追踪。 如果你想要你发现的 Bug 被快速解决，最好的办法就是通过我们提供的 <a
                                            href='//github.com/shine-design/shine-design/blob/master/.github/ISSUE_TEMPLATE/bug_report.md'>Bug
                                            Report</a> 模板
                                            来提供重现。</p>
                                        <p>在你报告一个 bug 之前，请先确保已经搜索过已有的 Issue 和阅读了我们的 <a href='/faq'>FAQ</a>。</p>
                                        <h4>Features</h4>
                                        <p>如果你有改进我们的产品或者新增功能的想法，我们同样推荐你使用我们提供的 <a
                                            href='//github.com/shine-design/shine-design/blob/master/.github/ISSUE_TEMPLATE/feature_request.md'>Feature
                                            Request</a> 模板来新建一个添加新功能的 Issue。</p>
                                        <h4>第一次贡献</h4>
                                        ...
                                        <p>在你 clone 了 Shine Design 的代码并且使用 <code>npm
                                            install</code> 安装完依赖后，你还可以运行下面几个常用的命令：</p>
                                        <ol>
