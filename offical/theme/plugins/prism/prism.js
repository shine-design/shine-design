                ...
                for (let i = 0; i < tokens.length; i++) {
                    ...
                    if (typeof token === 'string' || (token.content && typeof token.content === 'string')) {
                        ...
                        if (index > -1) {
                            ...
                            const middle = new Prism.Token(language, Prism.tokenize(t, env.grammar, language), 'language-' + language, t);
